...
window.STAGE3_BANKS.ds = [
  {
    ...
    text: '如果数据科学已经是你的主方向，你最想长期练强哪种“判断方式”？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你更想做“预测和建模”，哪类问题最值得你长期投入？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你最在意“这个动作到底有没有用”，更想长期做哪类工作？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你更在意“数据这件事本身要先可靠”，最想长期攻哪类问题？',
    opts: [
  ...
  },
  {
    ...
    text: '如果最后总要把分析结果交给别人用，你最想长期练哪类能力？',
    opts: [
  ...
  },
  {
    ...
    text: '如果未来想把数据方法放进真实世界，你最可能长期留在哪类场景？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你更相信“分析和模型最终要在生产里站住”，最想长期补哪类能力？',
    opts: [
  ...
  },
  {
    ...
    text: '如果未来一年都围着一种“数据材料”打磨，你更想选哪种？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你长期做“模型与判断”，更想把哪类能力做成自己的主标签？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你更在意“数据方法最终怎样在真实系统里长期运行”，最想长期做哪类事情？',
    opts: [
      ...
      { t: '把数据方法真正嵌进医疗、金融、城市或产业场景里', d: { domain_ds: 4, health_ds: 1, finance_ds: 1 } },
  ...
  },
  {
    ...
    mustBranch: true,
    branchOrder: 1,
    text: '如果 DS / Statistics 已经是你的主方向，你更想长期把哪类“数据工作能力”做成主线？',
    opts: [
      ...
      { t: '行业数据科学，重点是把方法放进医疗、金融、制造或城市问题里', d: { domain_ds: 2, industrial_ds: 1, health_ds: 1, finance_ds: 1, mobility_ds: 1 } }
    ]
  },
  {
    id: 's3_ds_branch_02',
