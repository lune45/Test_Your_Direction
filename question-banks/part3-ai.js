...
window.STAGE3_BANKS.ai = [
  ...
  },
  {
    ...
    opts: [
      { t: '让模型在高风险场景里更稳，不容易越界、失控或被诱导', d: { safety: 4, xai: 1, prob_ml: 1 } },
  ...
  },
  {
    ...
    opts: [
      ...
      { t: '让模型面对陌生任务时也更稳、更少崩掉', d: { transfer: 4, meta_learning: 1, prob_ml: 1 } },
  ...
  },
  {
    ...
    text: '如果你更想研究“模型为什么会学得更快、更稳”，最想长期钻哪类问题？',
    opts: [
      { t: '让模型在新任务上用更少样本就能快速适应', d: { meta_learning: 3, transfer: 1, prob_ml: 1 } },
      { t: '把不确定性也建进模型里，知道什么时候该更谨慎', d: { prob_ml: 3, bayes_ml: 2, safety: 1 } },
      { t: '把先验知识和数据更新放在一起，让判断更稳', d: { bayes_ml: 3, prob_ml: 1, applied_ai: 1 } },
      { t: '把训练过程做得更快、更稳、更省算力', d: { training_eff: 3, efficient: 1, inf_opt: 1 } }
    ]
  },
  {
    id: 's3_ai_12',
    ...
    text: '如果你更在意“模型怎样和真实内容世界对上”，最想长期做哪类问题？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你长期留在“语言与信息系统”这条线上，最想把哪类能力做成自己的代表作？',
    opts: [
      { t: '把长文本、术语和结构化信息理解得更稳，真正读懂内容', d: { nlp: 3, doc_intel: 1, ir: 1 } },
  ...
  },
  {
    ...
    cat: 'AI 深挖 / 训练与部署细化',
    triggerDirs: ['training_eff', 'model_compression', 'quant', 'inf_opt'],
    text: '如果你想把“模型能跑起来”这条线做深，最想长期攻哪类瓶颈？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你更着迷于“模型是怎么学会东西的”，最想长期做深哪一类？',
    opts: [
      ...
      { t: '让模型面对新任务时学得更快、更像会举一反三', d: { meta_learning: 4, transfer: 1, repr: 1 } }
    ]
  },
  {
    id: 's3_ai_17',
    ...
    opts: [
      ...
      { t: '先验、不确定性和数据更新怎样一起让判断更稳', d: { bayes_ml: 4, prob_ml: 2 } }
    ]
  },
  {
    id: 's3_ai_18',
    ...
    text: '如果你最终留在生成式方向，最想长期把哪条路线做深？',
    opts: [
      { t: '围绕生成模型本身的能力边界和训练范式持续推进', d: { generative: 4, foundation: 1, controllable_gen: 1 } },
      { t: '把扩散模型在图像、视频等内容生成里做到更稳更强', d: { diffusion: 4, image_generation: 1, controllable_gen: 1 } },
      { t: '把序列生成和自回归路线做得更强、更可控', d: { autoregressive: 4, llm: 1, controllable_gen: 1 } },
  ...
  },
  {
    ...
    cat: 'AI 深挖 / 可信系统细分',
    triggerDirs: ['safety', 'xai', 'fairness', 'prob_ml'],
    text: '如果你长期做“可信 AI”，你更想把哪一层做成自己的标志能力？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你长期留在“语言与信息系统”这条线上，更想把哪类能力做成核心竞争力？',
    opts: [
      { t: '把文本、术语和结构化知识理解得更细、更稳、更可计算', d: { nlp: 4, doc_intel: 1, ir: 1 } },
  ...
  },
  {
    ...
    text: '如果你长期做“视觉内容与世界表示”，更想把哪条路线做成自己的代表作？',
    opts: [
      ...
      { t: '把图像或视频生成做得更稳、更细、更能按要求输出', d: { image_generation: 4, diffusion: 1, controllable_gen: 1 } },
  ...
  },
  {
    ...
    text: '如果你长期做“系统怎么做决定”，更想把哪种学习路径做深？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你长期做“系统怎样看懂世界”，更想把哪类能力做成自己的代表作？',
    opts: [
      ...
      { t: '把医学影像里的异常、风险和辅助判断做得更稳、更可解释', d: { med_vision: 4, visual_understanding: 1, xai: 1 } },
  ...
  },
  {
    ...
    text: '如果你长期研究“很多决策单元怎样一起行动”，更想把哪类问题做深？',
    opts: [
      ...
      { t: '在信息不全、风险较大时仍能做出更稳妥的动作选择', d: { decision_uncertainty: 4, prob_ml: 1, planning_ai: 1 } }
    ]
  },
  {
    id: 's3_ai_26',
    ...
    text: '如果你长期做“模型怎样更省、更稳、更能部署”，更想把哪类能力做成强项？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你长期研究“模型能力为什么会出现、又会在哪失效”，更想把哪类问题做成自己的主线？',
    opts: [
  ...
  },
  {
    ...
    text: '如果你长期留在“语言与检索”这一侧，更想把哪类能力做成代表作？',
    opts: [
      { t: '把大语言模型本身做得更会推理、更稳、更像通用能力底座', d: { llm: 4, foundation: 1, nlp: 1 } },
  ...
  },
  {
    ...
    cat: 'AI 深挖 / 可信能力分解',
    triggerDirs: ['safety', 'xai', 'fairness', 'prob_ml'],
    text: '如果你长期做“可信 AI”，你更想把哪种能力做到别人很难替代？',
    opts: [
  ...
  },
  {
    ...
    mustBranch: true,
    branchOrder: 1,
    text: '如果 AI 已经确定是你的主方向，你最想长期把哪类“核心能力”做成自己的主线？',
    opts: [
  ...
  },
  {
    ...
    mustBranch: true,
    branchOrder: 2,
    text: '如果你继续在 AI 里往深走，你更想长期解决哪一类“真正卡住能力上限”的问题？',
    opts: [
      { t: '模型为什么会学会，为什么有时泛化、有时突然失效', d: { ml_theory: 2, stat_learn: 2, scaling: 2, opt_ml: 1, prob_ml: 1 } },
      { t: '模型怎样更稳、更可信、更少失控，也更容易被人理解', d: { safety: 2, xai: 2, fairness: 2, prob_ml: 1, bayes_ml: 1 } },
      { t: '模型怎样训练得更稳、部署得更快、成本更可控', d: { training_eff: 3, inf_opt: 2, model_compression: 1, quant: 1 } },
  ...
  },
  {
    ...
    mustBranch: true,
    branchOrder: 3,
    text: '如果几年后别人提起你的 AI 方向，你更希望第一反应是你最擅长哪一类问题？',
    opts: [
      ...
      { t: '把智能体、规划和长期决策做得更像能自己完成任务的系统', d: { rl: 2, planning_ai: 2, offline_rl: 1, multiagent: 1, decision_uncertainty: 2 } }
    ]
  },
  {
    id: 's3_ai_branch_04',
    ...
    text: '如果你更偏“模型为什么会学会东西”这条线，最想长期把哪一块做成自己的主线？',
    opts: [
      ...
      { t: '把先验知识和数据更新放在一起，让判断随着证据更稳地修正', d: { bayes_ml: 4, prob_ml: 1 } },
      { t: '把训练和部署做得更稳、更省、更能扛规模', d: { training_eff: 3, inf_opt: 1, model_compression: 1, quant: 1 } }
    ]
  },
  {
    id: 's3_ai_branch_05',
    ...
    text: '如果你长期留在“语言与信息系统”这条线上，更想把哪类能力做成自己的招牌？',
    opts: [
      ...
      { t: '把语音、音频和自然说话场景做得更稳、更自然', d: { speech: 4, nlp: 1, audio_visual: 1 } },
  ...
  },
  {
    ...
    text: '如果你长期做“看世界、跨模态或生成”，更想先把哪类能力做到特别强？',
    opts: [
      ...
      { t: '把图像或视频生成本身做强，让生成结果更稳、更细、更能按要求输出', d: { image_generation: 4, diffusion: 1 } },
  ...
  },
  {
    ...
    text: '如果你更在意“系统最后会表现成什么样”，最想把哪类能力做成自己最稳定的强项？',
    opts: [
      { t: '让模型在高风险场景里更稳，不容易越界、失控或被诱导', d: { safety: 4, controllable_gen: 1, xai: 1 } },
      { t: '让模型为什么这样判断变得可追溯、可解释、可修正', d: { xai: 4, fairness: 1, prob_ml: 1 } },
      { t: '让不同群体拿到更公平的结果，把偏差问题长期压下去', d: { fairness: 4, xai: 1, applied_ai: 1 } },
      { t: '让系统在不确定、信息不完整时也能做出更稳妥的决定', d: { decision_uncertainty: 3, prob_ml: 2, planning_ai: 1 } },
      ...
      { t: '把大模型知识稳定迁到小模型里，让轻量版本真正可用', d: { distillation: 4, model_compression: 1, transfer: 1 } },
      { t: '把训练过程本身做得更高效、更稳定、更能扛规模', d: { training_eff: 4, inf_opt: 1 } },
      { t: '把量化和推理链路做实，让模型部署更快、更省、更稳', d: { quant: 2, inf_opt: 2, model_compression: 1 } },
